# 專業複委託 (Professional Sub-consultants)

## Skills

* [結構系統](結構系統/structural-systems/SKILL.md) - Designing and analyzing building structural systems, including seismic design, structural system selection, and load calculation
<<<<<<< HEAD
* [機電系統](機電系統/building-services/SKILL.md) - Designing building MEP systems including HVAC, plumbing, electrical, fire protection, and system integration
=======
* [機電系統 — 總覽](機電系統/building-services/SKILL.md) - Designing building MEP systems including HVAC, plumbing, electrical, fire protection, and system integration
* [機電系統 — 台電屋內線路安培容量](機電系統/taipower-indoor-wiring-ampacity/SKILL.md) - Allowable ampacity of indoor electrical wiring and conduit fill limits per Taipower Indoor Wiring Regulations
* [機電系統 — 台電配電場所圖審文件](機電系統/taipower-substation-review-docs/SKILL.md) - Required document checklists for Taipower substation room and indoor wiring design review
